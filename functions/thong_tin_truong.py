...
data_path = os.path.join(
    os.getcwd(), "rag_n_function_calling", "data", "txt_data", "Thông tin trường"
)

class ThongTinTruong(RagMini):
    def __init__(self):
        self.retriever = Retriever(data_path)
        self.description = "Cung cấp các thông tin về trường đại học mà bạn cần biết."
...
thong_tin_truong_rag = ThongTinTruong()

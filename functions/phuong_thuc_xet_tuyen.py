...
data_path = os.path.join(
    os.getcwd(), "rag_n_function_calling", "data", "txt_data", "Phương thức xét tuyển"
)

class PhuongThucXetTuyen(RagMini):
    def __init__(self):
        self.retriever = Retriever(data_path)
        self.description = "Cung cấp thông tin về phương thức xét tuyển mà bạn cần biết."
...
phuong_thuc_xet_tuyen_rag = PhuongThucXetTuyen()

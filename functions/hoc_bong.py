...
data_path = os.path.join(
    os.getcwd(), "rag_n_function_calling", "data", "txt_data", "Học bổng"
)

class HocBong(RagMini):
    def __init__(self):
        self.retriever = Retriever(data_path)
        self.description = "Cung cấp thông tin về các loại học bổng của trường mà bạn cần biết."
